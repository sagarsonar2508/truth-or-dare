  ...
  return (
    <View style={styles.container}>
      <View style={styles.background}>
        ...
        {/* <MaterialCommunityIcons name="flash" size={100} color="#ff1493" style={styles.icon}/> */}
        <Text style={styles.dialogText}>
          Cheesy dialog for Truth and Dare in the Spicy category. Let the spicy adventures begin!
        </Text>
        <View style={styles.content}>
          <TouchableOpacity style={styles.button} onPress={() => handlePlayButtonClick({ level: 'extreme', category: 'couple' })}>
            <View style={styles.inButton}>
              <Text style={styles.buttonText}>For Couple</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity style={styles.button} onPress={() => handlePlayButtonClick({ level: 'extreme', category: 'company' })}>
            <View style={styles.inButton}>
